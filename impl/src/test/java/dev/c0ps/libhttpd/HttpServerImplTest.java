...
public class HttpServerImplTest {
    ...
    // random port to avoid collision of the tests with any service on the developer machine
    private static final int SERVER_PORT = 13254;
    private static final String SERVER_ROOT = "/";
    private static final String SERVER_URL = "http://localhost:" + SERVER_PORT + SERVER_ROOT;
    ...
    public void setup() {
        ...
        sut = new HttpServerImpl(injector, SERVER_PORT, SERVER_ROOT);
